...
export function WeatherOutfitAdvisor() {
  ...
  return (
    <div className="min-h-screen bg-[#fffafa] p-8">
        ...
        <Card className="shadow-lg">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-purple-300 text-white shadow-lg shadow-purple-200/50 hover:bg-pink-400 hover:shadow-pink-200/50"
                size="lg"
              >
                服装を提案してもらう
              </Button>
